...
class _ProposalTargetLayer(nn.Module):
    ...
    def _sample_rois_pytorch(self, all_rois, gt_boxes, fg_rois_per_image, rois_per_image):
        ...
        labels = gt_boxes[:,:,4].contiguous().view(-1)[(offset.view(-1),)].view(batch_size, -1) # B * #ROIS
        ...
        for i in range(batch_size):
            ...
            #print(torch.unique(labels_batch[i]))
            ...
            gt_rois_batch[i,:,:4] = gt_boxes[i][gt_assignment[i][keep_inds], :4]
