...
class ImageDataset(Dataset):
    ...
    def _load_image_data(self):
        ...
        if cfg.TRAIN.PROPOSAL_TYPE=='SS':
            ...
            cache_file = os.path.join(self.cache_path, self.name + '_EB_gt_roidb.pkl')
        elif cfg.TRAIN.PROPOSAL_TYPE=='CAM_SS':
            cache_file = os.path.join(self.cache_path, self.name + '_CAM_SS440_gt_roidb.pkl')
        else:
        ...
        if os.path.exists(cache_file):
            ...
            image_data = self._load_object_proposals(image_data) #load the object proposals to be used as pseudo GT
